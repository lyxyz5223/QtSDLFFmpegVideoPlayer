...
////}
//
//inline void SleepForMs(uint64_t duration)
//{
...
//
//
//inline void SleepForUs(uint64_t duration)
//{
...
inline void SleepForS(uint64_t duration)
{
...
inline void SleepForNs(uint64_t duration)
{
